...
class Inspiring
{
    ...
    public static function quotes()
    {
        return Collection::make([
            ...
            'Ngoding itu mudah dan menyenangkan bukan? BUKAN!! - Fadila Rahman',
            'Tidak ada kata kata, yang ada bukti nyata - ???',
            'Di dunia ini tidak ada yang instan, kecuali tahu bulat yang di goreng dadakan - Mamang Tahu Bulat'
        ]);
    }
